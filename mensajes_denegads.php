...
<head>
    ...
    <?php
        ...
        if(isset($_GET['idadmitir'])){
            ...
            header("Location:./mensajes_denegados.php?grupo=". $_SESSION['grupo']);
        }
    ...
    try{     
        ...
        if($num_filas !=0){
            ...
            while($fila=$stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                $datos.= "<div><p><a href='./mensajes_denegados.php?idadmitir=".$fila['idpost']."'>Admitir</a> |<a href=''>Eliminar</a></p></div>";
                $datos.= "</div>";
                $datos.="</p>";
